...
public class PastWrapped1 extends AppCompatActivity {
    ...
    public void onStart() {
        ...
        wrapped1_next_btn.setOnClickListener(view -> {
            startActivity(new Intent(this, PastWrapped2.class));
        });
                    ...
                    public void onSuccess(List<ArtistInfo> topArtists) {
                        runOnUiThread(() -> {
                            if (topArtists.size() >= 5) {
                                ...
                                Toast.makeText(PastWrapped1.this, "Must have listened to at least 5 artists", Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
